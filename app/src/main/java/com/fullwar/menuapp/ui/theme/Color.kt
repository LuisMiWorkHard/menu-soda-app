package com.fullwar.menuapp.ui.theme
...
val AccentGrey = Color(0xFFBDBDBD)   // Gris claro para acentos y elementos secundarios
val PureWhite = Color(0xFFFFFFFF)    // Texto principal y contrastes altos
val SubtleDivider = Color(0x1FFFFFFF) // Divisores sutiles con opacidad
*/
...
val RichBlack = Color(0xFF202124)//Color(0xFF1E1E1E)
val ShadowGrey = Color(0xFF202124) //Color(0xFF353535)
...
val SoftBone = Color(0xFFEFEFEF) //Color(0xFFF5F5F5)
